...
# X_resampled = load_pickle("X_resampled_renn_8")
# y_resampled = load_pickle("y_resampled_renn_8")
...
save_pickle(pre,"RFIM_pre_1234510_"+sys.argv[1])
save_pickle(rec,"RFIM_rec_1234510_"+sys.argv[1])
